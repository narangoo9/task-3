...
document.addEventListener('DOMContentLoaded', () => {
            ...
            tasksList.querySelectorAll('.task-btn-check').forEach(btn => {
                btn.addEventListener('click', async (e) => {
                    ...
                    if (currentPage === 'taskList') {
                        ...
                        // On dashboard, re-render to hide completed task
    ...
    appState.subscribe((state) => {
        ...
        if (state && state.tasks !== undefined) {
            ...
            if (searchQuery && currentPage === 'dashboard' && searchChanged) {
                ...
                // Clear search results and show normal tasks
                renderTasks();
                lastSearchQuery = '';
            ...
            } else if (currentPage === 'dashboard' && pageChanged) {
                // Show dashboard page
                showDashboardPage();
                lastPage = currentPage;
        ...
        container.querySelectorAll('.task-btn-check[data-task-id]').forEach(btn => {
            btn.addEventListener('click', async (e) => {
                ...
                if (currentPage === 'taskList') {
                    ...
                    // On dashboard, re-render to update progress or hide completed task
                    const tasks = appState.getStateProperty('tasks') || [];
                    renderTasks(tasks);
                }
            });
    ...
    function showDashboardPage() {
        ...
        // Re-render tasks for dashboard (only active)
        const tasks = appState.getStateProperty('tasks') || [];
        renderTasks(tasks);
    }
